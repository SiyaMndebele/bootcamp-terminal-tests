module.export = function mostProfitableDepartment(salesDataa) {
    const departListing = {};
  ...
  function mostProfitableDay(salesDatab) {
    const profit = {};
    for (var i=0; i<salesDatab.length;i++) {
      const prod1 = salesDatab[i];
      profit[prod1.day] = 0;
    }
    for (var i=0 ; i<salesDatab.length;i++) {
      const prod1 = salesDatab[i];
